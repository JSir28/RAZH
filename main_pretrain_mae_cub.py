...
import models_mae_mae_cub

from engine_pretrain_mae_cub import train_one_epoch
...
def get_args_parser():
    ...
    # Dataset parameters
    parser.add_argument('--data_path', default='D:/jy/datasets/CUB_200_2011/CUB_200_2011/', type=str,
                        help='dataset path')
...
def main(args):
    ...
    # define the model
    model = models_mae_mae_cub.__dict__[args.model](norm_pix_loss=args.norm_pix_loss,hash_length=args.hash_length,unseen_classes=unseen)
...
def validata(args,data_loader_train, model, epoch,max_map, log_writer):
    ...
    for sample in enumerate(test_loader):
        ...
        if epoch%100==0 or epoch + 1 == args.epochs:
            ...
            one_hot_label = F.one_hot(target,200)
