...
class MaskedAutoencoderViT(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=16, in_chans=3,
                 ...
                 mlp_ratio=4., norm_layer=nn.LayerNorm, norm_pix_loss=False, num_classes=10, attr=None,alpha=1e-1,gamm=1e-1,
                 unseen_classes=None):
        super().__init__()
...
def mae_vit_base_patch16_dec512d8b(**kwargs):
    w2v_att = torch.from_numpy(np.load('/mnt/f88fa63a-2225-40fb-9afa-99a7c125ae28/jy/mae_jy_cifar10/word2vec/cifar10_word2vec_300d.npy'))
