...
def main(args):
    ...
    args.log_dir = args.log_dir + "/2412/" + str(args.mask_ratio) + "/param/" + str(args.hash_length) + "_" + str(
    ...
    # define the model
    model = models_mae_ablation.__dict__[args.model](norm_pix_loss=args.norm_pix_loss, unseen_classes=unseen,
