...
class My_Loss(nn.Module):
    def __init__(self, num_classes, hash_code_length, mixup_fn, smoothing, alpha, beta, gamm, unseen):
        super().__init__()
    ...
    def forward(self, hash_out, cls_out, target):
        ...
        # cla_loss = self.compute_loss_Self_Calibrate(cls_out)
        loss = (0*cls_loss) + self.alpha*hash_loss
